package com.example.movie_app_rest_api.config;
...
public class OpenAPIConfig {
	...
	public OpenAPI myOpenAPI() {
		...
		Info info = new Info().title("MOVIE APP REST API").version("1.0").contact(contact)
				.description("This API exposes endpoints to manage MOVIE BOOKING OPERATIONS.")
